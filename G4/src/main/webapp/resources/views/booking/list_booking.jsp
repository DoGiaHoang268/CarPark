...
<body style="background-color: white;">0
				...
				<div class="container1">
					<div style="padding-bottom: 50px; margin-top: 50px;">
						...
						<div class="" style="float: right; padding-right: 20px;">
							<form class="form-inline" action="${pageContext.request.contextPath}/SearchBooking" method="post">
								<!-- icon -->
							...
							<table class="table">
								...
								<tbody>
									...
									<tr>
										...
										<td>${x.destination}</td>
										<td><a
											href="/G4/ViewBooking?officeld=${x.officeld}"><i
					...
					<nav>
						<ul class="pagination">
							<c:forEach begin="1" end="${endP}" var="p">
								<li class="page-item"><a class="page-link" href="/G4/ListBooking?index=${p}">${p}</a></li>
							</c:forEach>
						</ul>
					</nav>
				</div>
