			...
			<div class="row">
				...
				<div class="row-right col-sm-10" style="background-color: white">
								...
								<form class="form-inline"
									...
									<div>
										<select class="form-control mr-sm" name="select" id="select"
											...
											<option value="2">Booking Time </option>
											<option value="3">Custumer Name</option>
											<option value="4">License Plate</option>
											<option value="5">Trip</option>
										</select>
									</div>
									<div class="form-control mr-sm">
					...
					<div class="container2 ">
						...
						<form
							action="${pageContext.request.contextPath}/ListTicketController">
							<!-- table -->
									...
									<tbody>
										<c:forEach items="${listT}" var="t">
											<tr>
												...
												<td>${t.bookingTime}</td>
												<td><a
													href="${pageContext.request.contextPath}/DeleteTicketController?ticketId=${t.ticketId}"
							...
							<ul class="pagination">
								<c:forEach begin="1" end="${endP}" var="p">
									<li class="page-item"><a class="page-link"
										href="${pageContext.request.contextPath}/ListTicketController?index=${p}">${p}</a></li>
								</c:forEach>
							</ul>
						</nav>
					</div>
