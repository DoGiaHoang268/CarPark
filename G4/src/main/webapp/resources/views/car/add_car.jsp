			...
			<div class="row">
				...
				<div class="row-right col-sm-10" style="background-color: white">
					...
					<div class="container2 ">
						...
						<form action="/G4/AddCarController" method="post">

							<!-- add License plate -->
							<p class="col-12" style="color: #4CAF50">${message1}</p>
							<p class="col-12" style="color: red">${message}</p>
							...
							<div class="form-group row">
								...
								<div class="col-5">
									<input id="cartype" name="cartype"
										...
										required="required" type="text" value="${cartype}">
								</div>
							</div>
							<!-- Car color -->
							<div class="form-group row">
								...
								<div class="col-5">
									<select class="form-control mr-sm" name="company" id="company"
										...
										<option value="FPT software"
											${company == 'FPT software'?"selected":""}>FPT
											software</option>
										<option value="FPT university"
											${company == 'FPT university'?"selected":""}>FPT
											university</option>
										<option value="Viettel" ${company == 'Viettel'?"selected":""}>Viettel</option>
							...
							<div class="form-group row">
								...
								<div class="col-5">
									<select class="form-control mr-sm" name="parking" id="parking"
										style="border: 1px solid #e8e8e8; border-radius: 5px;">
										<option value="1" ${parking == 1?"selected":""}>Bai
											so 1</option>
										<option value="2" ${parking == 2?"selected":""}>Bai
											so 2</option>
										<option value="3" ${parking == 3?"selected":""}>Bai
											so 3</option>
