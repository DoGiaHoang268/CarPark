				...
				<div class="row-right col-sm-10" style="background-color: white">
								...
								<form class="form-inline"
									...
									<div>
										<select class="form-control mr-sm" name="select" id="select"
											...
											<option value="1">License plate</option>
											<option value="3">Car type</option>
											<option value="4">Car color</option>
											<option value="5">Company</option>
											<option value="6">Parking lot</option>
										</select>
									</div>
									<!-- btn search -->
									<button class="btn"
					...
					<div class="container2 ">
						...
						<form
							...
							<p class="col-12" style="color: red">${message1}</p>
							<div class="table1"
							...
							<ul class="pagination">
								<c:forEach begin="1" end="${endP}" var="p">
									<li class="page-item"><a class="page-link"
										href="${pageContext.request.contextPath}/ListCarController?index=${p}">${p}</a></li>
								</c:forEach>
							</ul>
						</nav>
					</div>
